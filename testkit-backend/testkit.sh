...
python3 -m unittest tests.neo4j.test_bookmarks.TestBookmarks.test_can_pass_read_bookmark_into_write_session || EXIT_CODE=1
#
##test_session_run
...
#python3 -m unittest tests.neo4j.test_tx_run.TestTxRun.test_interwoven_queries  || EXIT_CODE=1 // broken pipe
